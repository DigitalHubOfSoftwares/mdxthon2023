...
const Login : React.FC<Props> = ({ onSubmit, email, setEmail, password, setPassword }) => {

	return(
		<section className="bg-dark-bg flex h-screen bg-no-repeat bg-cover bg-center dark:bg-dark-bg">
			<div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
				<div className="w-full bg-white rounded-lg shadow-2xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800/[.6] dark:backdrop-blur-sm dark:border-gray-700">
					<div className="p-6 space-y-4 md:space-y-6 sm:p-8">
						...
						<form className="space-y-4 md:space-y-6" onSubmit = {onSubmit}>
							<div>
								...
								<input type="email" name="username" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#BF13E3] focus:border-[#BF13E3] block w-full p-2.5 dark:bg-gray-700/[.15] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#BF13E3] dark:focus:border-[#BF13E3]" placeholder="name@company.com" onChange={(e) => setEmail(e.target.value)} value={email} required/>
							</div>
							<div>
							...
							<p className="text-sm font-light text-gray-500 dark:text-gray-400">
								Don’t have an account yet? <Link href="/register" className="font-medium text-[#81007f] hover:underline dark:text-[#BF13E3]">Sign up</Link>
							</p>
							<p className="text-sm font-light text-gray-500 dark:text-gray-400">
								Don’t want an account yet? <Link href="/" className="font-medium text-[#81007f] hover:underline dark:text-[#BF13E3]">Go to Home</Link>
							</p>
						</form>
